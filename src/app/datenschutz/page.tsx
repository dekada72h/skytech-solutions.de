...
export const metadata: Metadata = {
  title: 'Datenschutzerklärung – Skytech Solutions',
  description: 'Datenschutzerklärung von Skytech Solutions gemäß DSGVO.',
};

export default function Datenschutz() {
  return (
    <LegalLayout title="Datenschutzerkl&auml;rung">
      ...
      <ul>
        <li>Auskunft &uuml;ber Ihre bei uns gespeicherten personenbezogenen Daten zu erhalten (Art. 15 DSGVO)</li>
        <li>Berichtigung unrichtiger Daten zu verlangen (Art. 16 DSGVO)</li>
        <li>L&ouml;schung Ihrer Daten zu verlangen (Art. 17 DSGVO)</li>
        <li>Einschr&auml;nkung der Verarbeitung zu verlangen (Art. 18 DSGVO)</li>
        <li>Daten&uuml;bertragbarkeit zu verlangen (Art. 20 DSGVO)</li>
      ...
      <p>
        ...
        Aufsichtsbeh&ouml;rde zu beschweren.
      </p>
    </LegalLayout>
  );
}
