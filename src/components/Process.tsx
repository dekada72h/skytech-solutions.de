...
const steps = [
  ...
  },
  {
    ...
    description:
      'Am vereinbarten Termin kommen wir mit unserer Drohnentechnik und reinigen Ihre Anlage – schnell, sicher und gründlich.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description:
      'Nach der Reinigung erhalten Sie ein vollständiges Foto-Protokoll mit Vorher-Nachher-Bildern – ideal für Ihre Buchhaltung und steuerliche Absetzbarkeit.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
