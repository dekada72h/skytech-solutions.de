...
export default function RoiCalculator() {
  ...
  const results = useMemo(() => {
    ...
    const currentLossRate = Math.min(annualSoilRate * cleaningData.multiplier, 0.3);
              ...
              >
                ...
                <div className="rounded-xl border border-red-100 bg-red-50 p-5 text-center sm:p-6">
                  <div className="flex items-center justify-center gap-2 text-red-700">
                    <WarningIcon className="h-5 w-5" strokeWidth={2} />
                ...
                <div className="rounded-xl border border-accent-200 bg-accent-50 p-4">
                  <div className="flex items-start gap-3">
                    <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-accent-100">
                      <CheckIcon className="h-5 w-5 text-accent-600" strokeWidth={2} />
                    </div>
                    <div>
